...
public class DataF implements Parcelable {
    ...
    public static final Parcelable.Creator<DataF> CREATOR = new Parcelable.Creator<DataF>() {
        @Override
        public DataF createFromParcel(Parcel source) {
            return new DataF(source);
        }

        @Override
        public DataF[] newArray(int size) {
            return new DataF[size];
        }
    };
}
